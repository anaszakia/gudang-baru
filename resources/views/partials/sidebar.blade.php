...
<div id="sidebar" class="fixed inset-y-0 left-0 z-30 w-64 bg-white shadow-lg transform -translate-x-full transition-all duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 flex flex-col border-r border-gray-200">
    ...
    <div class="flex items-center justify-between h-16 px-4 border-b border-gray-200">
        <div class="flex items-center space-x-3">
            ...
            <span class="text-lg font-semibold text-gray-800 sidebar-text">Gudang Panel</span>
        </div>
    ...
    <nav class="flex-1 px-4 py-4 overflow-y-auto">
        <ul class="space-y-2">
            ...
            <li>
                <a href="@if(auth()->user()->role === 'admin-super')
            ...
            @if(auth()->user()->role === 'admin-super')
                ...
                <li class="relative">
                    ...
                    <div id="dropdown-content" class="hidden mt-1 ml-8 space-y-1 dropdown-content">
                        <a href="{{ route('admin-super.users.index') }}" class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-md hover:bg-gray-100 hover:text-blue-600 transition-all duration-200">
                            <i class="fas fa-user-friends w-4 h-4 mr-3"></i>
                            <span class="sidebar-text">Users</span>
                        </a>
                        <a href="{{ route('admin-super.kategoris.index') }}" class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-md hover:bg-gray-100 hover:text-blue-600 transition-all duration-200">
                            <i class="fas fa-tags w-4 h-4 mr-3"></i>
                            <span class="sidebar-text">Kategori Produk</span>
                        </a>
                        <a href="{{ route('admin-super.produks.index') }}" class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-md hover:bg-gray-100 hover:text-blue-600 transition-all duration-200">
                            <i class="fas fa-box-open w-4 h-4 mr-3"></i>
                            <span class="sidebar-text">Produk</span>
                        </a>
                        <a href="{{ route('admin-super.barang-masuk.index') }}" class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-md hover:bg-gray-100 hover:text-blue-600 transition-all duration-200">
                            <i class="fas fa-arrow-circle-down w-4 h-4 mr-3"></i>
                            <span class="sidebar-text">Barang Masuk</span>
                        </a>
                        <a href="{{ route('admin-super.barang-keluar.index') }}" class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-md hover:bg-gray-100 hover:text-blue-600 transition-all duration-200">
                            <i class="fas fa-arrow-circle-up w-4 h-4 mr-3"></i>
                            <span class="sidebar-text">Barang Keluar</span>
                        </a>
                        <a href="{{ route('admin-super.audit.index') }}" class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-md hover:bg-gray-100 hover:text-blue-600 transition-all duration-200">
                            <i class="fas fa-clipboard-list w-4 h-4 mr-3"></i>
                            <span class="sidebar-text">Audit Log</span>
                        </a>
                        <a href="{{ route('admin-super.penawaran.index') }}" class="flex items-center px-3 py-2 text-sm text-gray-600 rounded-md hover:bg-gray-100 hover:text-blue-600 transition-all duration-200">
                            <i class="fas fa-file-invoice w-4 h-4 mr-3"></i>
                            <span class="sidebar-text">Approval Penawaran</span>
                        </a>
                    </div>
                </li>
            ...
            @if(auth()->user()->role === 'admin-gudang')
                <li>
                    <a href="{{ route('admin-gudang.barang-masuk.index') }}" class="flex items-center px-3 py-2.5 text-sm font-medium text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-all duration-200 group">
                        <i class="fas fa-arrow-circle-down w-5 h-5 mr-3 text-gray-500 group-hover:text-blue-500"></i>
                        <span class="sidebar-text">Barang Masuk</span>
                    </a>
                </li>
                
                <li>
                    <a href="{{ route('admin-gudang.barang-keluar.index') }}" class="flex items-center px-3 py-2.5 text-sm font-medium text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-all duration-200 group">
                        <i class="fas fa-arrow-circle-up w-5 h-5 mr-3 text-gray-500 group-hover:text-blue-500"></i>
                        <span class="sidebar-text">Barang Keluar</span>
                    </a>
                </li>
                
                <li>
                    <a href="{{ route('admin-gudang.penawaran.index') }}" class="flex items-center px-3 py-2.5 text-sm font-medium text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-all duration-200 group">
                        <i class="fas fa-file-invoice w-5 h-5 mr-3 text-gray-500 group-hover:text-blue-500"></i>
                        <span class="sidebar-text">Approval Penawaran</span>
                    </a>
                </li>
            ...
            @if(auth()->user()->role === 'sales')
                <li>
                    <a href="{{ route('sales.penawaran.index') }}" class="flex items-center px-3 py-2.5 text-sm font-medium text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-all duration-200 group">
                        <i class="fas fa-file-invoice w-5 h-5 mr-3 text-gray-500 group-hover:text-blue-500"></i>
                        <span class="sidebar-text">Penawaran</span>
                    </a>
                </li>
