    ...
    <div class="bg-white rounded-lg shadow-sm border p-6">
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                {{-- Search Form --}}
                <form method="GET" action="{{ route('admin-super.barang-keluar.index') }}" class="flex gap-2">
                    <div class="relative">
                ...
                {{-- Add Button --}}
                <a href="{{ route('admin-super.barang-keluar.create') }}" 
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <a href="{{ route('admin-super.barang-keluar.invoice', $bk->id) }}" target="_blank"
                                ...
                                {{-- Delete Button --}}
                                <form action="{{ route('admin-super.barang-keluar.destroy', $bk) }}" method="POST" class="inline">
                                    @csrf @method('DELETE')
        ...
        <div x-show="detailModal === {{ $bk->id }}" x-cloak 
            ...
            <div @click.away="closeModal('detail')" 
                ...
                <div class="flex justify-end gap-3 p-6 border-t bg-gray-50">
                    <a href="{{ route('admin-super.barang-keluar.detail', $bk->id) }}" 
    ...
    @foreach($barangKeluars as $bk)
        <div x-show="editModal === {{ $bk->id }}" x-cloak 
            ...
            <div @click.away="closeModal('edit')" 
                ...
                {{-- Modal Content --}}
                <form method="POST" action="{{ route('admin-super.barang-keluar.update', $bk) }}" class="p-6">
                    @csrf @method('PUT')
...
<script>
    ...
    function exportData() {
        ...
        exportForm.action = '{{ route('admin-super.barang-keluar.export-excel') }}';
