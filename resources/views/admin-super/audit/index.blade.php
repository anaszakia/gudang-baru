...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <div id="filterForm" class="hidden mt-6 p-4 bg-gray-50 rounded-lg">
            <form method="GET" action="{{ route('admin-super.audit.index') }}" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {{-- Date Range --}}
                <div>
                ...
                <div class="lg:col-span-2 flex gap-2">
                    ...
                    <a href="{{ route('admin-super.audit.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium">
                        Reset
                    </a>
                </div>
            </form>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            @if($log->user_role)
                                @php
                                    ...
                                    $color = $roleColors[$log->user_role] ?? 'bg-gray-100 text-gray-800';
                                @endphp
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <a href="{{ route('admin-super.audit.show', $log) }}" 
...
function exportData() {
    ...
    exportForm.action = '{{ route('admin-super.audit.export') }}';
