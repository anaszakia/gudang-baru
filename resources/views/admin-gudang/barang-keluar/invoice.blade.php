...
<head>
    ...
    <title>Invoice - {{ $barangKeluar->kode_barang_keluar }}</title>
...
<body class="bg-white">
    ...
    <div class="no-print text-center py-4 bg-gray-50">
        ...
        <a href="{{ route('admin-gudang.barang-keluar.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-2 rounded">
            Kembali
        </a>
    </div>
    ...
    <div class="print-container bg-white mx-auto max-w-6xl p-6">
        ...
        <div class="border-b-2 border-gray-800 pb-4 mb-6">
            <div class="flex justify-between items-start">
                ...
                <div class="text-right">
                    ...
                    <p class="text-lg text-gray-600">BARANG KELUAR</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-8 mb-6">
            <div>
                ...
                <table class="text-sm">
                    <tr>
                        <td class="font-medium text-gray-700 pr-4 py-1">Kode Barang Keluar</td>
                        <td class="text-gray-800">: {{ $barangKeluar->kode_barang_keluar }}</td>
                    </tr>
                    <tr>
                        <td class="font-medium text-gray-700 pr-4 py-1">Tanggal</td>
                        <td class="text-gray-800">: {{ \Carbon\Carbon::parse($barangKeluar->tanggal_keluar)->format('d F Y') }}</td>
                    </tr>
                    <tr>
            ...
            <div>
                <h3 class="font-bold text-gray-800 mb-3 border-b border-gray-300 pb-1">PENERIMA</h3>
                <div class="text-sm">
                    <p class="font-bold text-gray-800 text-lg">{{ $barangKeluar->penerima }}</p>
                    <p class="text-gray-600 mt-1">Penerima Barang Keluar</p>
                </div>
            </div>
        </div>
        ...
        <div class="border border-gray-300 mb-6">
            <table class="w-full">
                ...
                <tbody>
                    @forelse($barangKeluar->detailBarangKeluars as $index => $detail)
            ...
            <div class="w-80">
                <table class="w-full border border-gray-300">
                    <tr class="border-b border-gray-200">
                        ...
                        <td class="py-2 px-4 text-sm text-right text-gray-800">{{ $barangKeluar->detailBarangKeluars->count() }} produk</td>
                    </tr>
                    <tr class="border-b border-gray-200">
                        <td class="py-2 px-4 text-sm font-medium text-gray-700">Total Kuantitas:</td>
                        <td class="py-2 px-4 text-sm text-right text-gray-800">{{ number_format($barangKeluar->detailBarangKeluars->sum('jumlah'), 0, ',', '.') }} unit</td>
                    </tr>
                    <tr class="bg-gray-100 font-bold">
                        <td class="py-3 px-4 text-sm text-gray-800">TOTAL NILAI:</td>
                        <td class="py-3 px-4 text-right text-lg text-gray-800">Rp {{ number_format($barangKeluar->detailBarangKeluars->sum('subtotal'), 0, ',', '.') }}</td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div class="border border-gray-300 p-4 mb-6 bg-gray-50">
            ...
            <div class="text-sm text-gray-700">
                <p>• Invoice ini merupakan bukti pengeluaran barang kepada penerima</p>
                ...
                <p>• Barang yang sudah keluar tidak dapat dikembalikan tanpa persetujuan</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 gap-12 mt-8">
            <div class="text-center">
                ...
                <div class="border-t border-gray-800 pt-2">
                    <p class="font-medium">{{ $barangKeluar->penerima }}</p>
