...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('admin-gudang.barang-keluar.finalize', $barangKeluar->id) }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2.5 rounded-lg transition-colors font-medium flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <form method="POST" action="{{ route('admin-gudang.barang-keluar.store-detail', $barangKeluar->id) }}" id="addProductForm" class="space-y-4">
                @csrf
                            ...
                            @foreach($barangKeluar->detailBarangKeluars as $index => $detail)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <form action="{{ route('admin-gudang.barang-keluar.destroy-detail', $detail->id) }}" method="POST" class="inline-block">
                                            @csrf
                                            @method('DELETE')
