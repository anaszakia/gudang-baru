    ...
    <div class="bg-white rounded-lg shadow-sm border p-6">
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                {{-- Search Form --}}
                <form method="GET" action="{{ route('admin-gudang.barang-masuk.index') }}" class="flex gap-2">
                    <div class="relative">
                ...
                {{-- Add Button --}}
                <a href="{{ route('admin-gudang.barang-masuk.create') }}" 
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex items-center justify-center space-x-2">
                                {{-- Detail Button --}}
                                <a href="{{ route('admin-gudang.barang-masuk.show', $bm->id) }}" 
                                ...
                                <a href="{{ route('admin-gudang.barang-masuk.invoice', $bm->id) }}" target="_blank"
                                ...
                                {{-- Edit Button --}}
                                <a href="{{ route('admin-gudang.barang-masuk.edit', $bm->id) }}" 
                                ...
                                {{-- Delete Button --}}
                                <form action="{{ route('admin-gudang.barang-masuk.destroy', $bm) }}" method="POST" class="inline">
                                    @csrf @method('DELETE')
...
<script>
    ...
    function exportData() {
        ...
        exportForm.action = '{{ route('admin-gudang.barang-masuk.export-excel') }}';
