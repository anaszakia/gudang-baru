...
<div x-data="{ 
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div class="xl:col-span-1">
            ...
            {{-- ACTION CARD untuk pending status --}}
            @if($penawaran->status == 'pending')
            <div class="bg-white rounded-lg shadow-sm border overflow-hidden mt-6">
                ...
                <div class="p-6">
                    <p class="text-gray-600 mb-4">Penawaran ini menunggu persetujuan Anda. Silakan proses penawaran ini.</p>
                    <a href="{{ route(Auth::user()->role . '.penawaran.approve', $penawaran) }}" 
                       class="bg-green-600 hover:bg-green-700 text-white px-4 py-3 rounded-lg transition-colors flex items-center gap-2 justify-center w-full">
